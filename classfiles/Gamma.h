...
// Tue Mar 13 23:58:12 2018 by ROOT version 6.12/06
// from TTree Gamma/Gamma
// found on file: ../data/AlephMC91.root
//////////////////////////////////////////////////////////
...
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("../data/AlephMC91.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("../data/AlephMC91.root");
      }
