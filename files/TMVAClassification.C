...
int TMVAClassification( TString myMethodList = "" )
{
   ...
   uygar*/
   dataloader->AddVariable( "anglePhiPi",'F');
   dataloader->AddVariable( "angleKpKm",'F');
   dataloader->AddVariable( "eDs",'F');
   dataloader->AddVariable("sumekpkm",'F');
   dataloader->AddVariable("anglePhiKp",'F');
   dataloader->AddVariable("anglePhiKm",'F');
   dataloader->AddVariable("anglePiKp",'F');
   dataloader->AddVariable("anglePiKm",'F');
