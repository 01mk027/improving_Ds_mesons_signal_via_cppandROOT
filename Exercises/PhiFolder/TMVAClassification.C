...
int TMVAClassification( TString myMethodList = "" )
{
   ...
   TFile *input(0);
   TString fname = "./tmvadataphi.root";
   ...
   TString outfileName( "TMVAp.root" );
   ...
   uygar*/
   dataloader->AddVariable( "diffeps",'F');
   dataloader->AddVariable( "angleKpKm",'F');
   dataloader->AddVariable( "m",'F');
 ...
 //dataloader->PrepareTrainingAndTestTree( mycuts, mycutb,
   ...
   dataloader->PrepareTrainingAndTestTree( mycuts, mycutb,
  "nTrain_Signal=3000:nTrain_Background=30000:nTest_Signal=3000:nTest_Background=30000:SplitMode=Random:NormMode=NumEvents:!V" );
